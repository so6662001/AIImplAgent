  ...
  <div>
    ...
    <div class="card">
      <el-table :data="customers" stripe>
        ...
        <el-table-column prop="fullName" label="客户全称" min-width="200" />
    ...
    <el-dialog v-model="showDialog" title="新增客户" width="700px" destroy-on-close>
      <el-form ref="formRef" :model="form" :rules="rules" label-width="120px">
        <el-row :gutter="16">
          <el-col :span="12">
            <el-form-item label="客户编码" prop="customerCode">
              <el-input v-model="form.customerCode" maxlength="32" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="客户类型">
              <el-select v-model="form.customerType" placeholder="请选择">
                <el-option label="终端用户" value="终端用户" />
...
import { createCustomer, listCustomers } from '@/api/archive'
...
const rules = {
  customerCode: [required('客户编码不能为空'), maxLen(32)],
  fullName: [required('客户全称不能为空'), maxLen(120)],
...
async function handleSubmit() {
  ...
  try {
    await createCustomer(form.value as unknown as Record<string, unknown>)
