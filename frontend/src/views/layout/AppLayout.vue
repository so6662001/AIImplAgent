<template>
  <el-container class="app-layout">
    ...
    <div v-if="isMobile" class="mobile-topbar">
      <el-icon @click="drawerOpen = true" class="hamburger"><Expand /></el-icon>
      <span class="mobile-title">AI交付平台</span>
    </div>
    ...
    <el-aside v-if="!isMobile" width="220px" class="sidebar">
      <div class="logo">
        ...
        <span class="logo-text">AI交付平台</span>
      </div>
      <el-menu
      ...
      >
        ...
        <el-menu-item index="/support-tickets">
        ...
        <el-menu-item index="/smart-input">
    ...
    <el-drawer v-if="isMobile" v-model="drawerOpen" direction="ltr" size="220px" :show-close="false">
      <template #header>
        <div class="logo">
          <span class="logo-icon">⬡</span>
          <span class="logo-text">AI交付平台</span>
...
<style>
/* Drawer body padding override (unscoped to reach el-drawer internals) */
.el-drawer__header {
  margin-bottom: 0;
  padding: 0;
  background: linear-gradient(180deg, #1a1a2e 0%, #16213e 100%);
